    ...
    def __init__(self):
        ...
        self.defaults_configs = {
            ...
            'html_message_template': (
                "HTML_MESSAGE_TEMPLATE",
                'email/verify_email/email_verification_msg.html'
            ),
            ...
            'verification_success_template': (
                'VERIFICATION_SUCCESS_TEMPLATE',
                'email/verify_email/email_verification_successful.html'
            ),
            ...
            'verification_failed_template': (
                'VERIFICATION_FAILED_TEMPLATE',
                'email/verify_email/email_verification_failed.html'
            ),
            ...
            'request_new_email_template': (
                'REQUEST_NEW_EMAIL_TEMPLATE',
                'email/verify_email/request_new_email.html'
            ),
