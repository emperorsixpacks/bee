...
settings = 1#Settings.objects.get(id=1)
charge =1 #settings.charge_in_percentage
deposit_text =2 #settings.deposit_text
withdraw_text =2 #settings.withdrawal_text
